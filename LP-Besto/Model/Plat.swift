...
struct Plat : Identifiable {
    ...
    static var mockData = [
        ...
        Plat(name: "Tenders de Poulets", contenu: [400, 75, 12], description: "Des tenders recette secrete de notre restaurant",  prix: 11.99,rating: 2.1),
        Plat(name: "Purée au Parmesan", contenu: [541, 32, 111], description: "Une purée faite avec amour, un plat très bon pour l'estomac",  prix: 12.99,rating: 1.0),
    ]
